...
const getPost = async function getPost(req: Request, res: IResponse, next: NextFunction) {
    let post
    try {
...
export { getAllPost, getAllPreview, getPost, getOnePost, createPost, patchPost, deletePost }